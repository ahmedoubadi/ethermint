...
import (
	...
	"github.com/ahmedoubadi/ethermint/ethereum/eip712"
	...
	"github.com/ahmedoubadi/ethermint/crypto/hd"
	"github.com/ahmedoubadi/ethermint/rpc/ethereum/backend"
	rpctypes "github.com/ahmedoubadi/ethermint/rpc/ethereum/types"
...
func (e *PublicAPI) Resend(ctx context.Context, args evmtypes.TransactionArgs, gasPrice *hexutil.Big, gasLimit *hexutil.Uint64) (common.Hash, error) {
	...
	for _, tx := range pending {
		// FIXME does Resend api possible at all?  https://github.com/ahmedoubadi/ethermint/issues/905
