...
SIMAPP = ./app
HTTPS_GIT := https://github.com/ahmedoubadi/ethermint.git
...
PACKAGE_NAME:=github.com/ahmedoubadi/ethermint
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/ahmedoubadi/ethermint/types"
	godoc -http=:6060
...
test-import:
	go test -run TestImporterTestSuite -v --vet=off github.com/ahmedoubadi/ethermint/tests/importer
